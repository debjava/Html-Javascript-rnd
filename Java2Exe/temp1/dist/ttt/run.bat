...
if not exist %DIRNAME% goto ENV_DIR_SETTING
...
:ENV_DIR_SETTING
echo current directory not accessible but may be accessible using environment variables
set DIRNAME="%EDI_HOME%"
...
:FOUND_RUN_JAR
java -jar %DIRNAME%\atcesadevices.jar
